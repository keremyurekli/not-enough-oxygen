...
public class NEOBucketItem extends NEOItem implements FluidModificationItem {
    //based on the default BucketItem
    private final Fluid fluid;

//    private final int maxLevel = 8;// 1000
//    moved
//    private final int level = 0;// 125 * 8

    public NEOBucketItem( Fluid fluid, Item.Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        BlockHitResult blockHitResult = NEOItem.raycast(
